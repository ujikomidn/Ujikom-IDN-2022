...
ip pool add name=dhcp_pool0 ranges=172.16.10.2-172.16.10.254
ip pool add name=dhcp_pool1 ranges=172.16.20.2-172.16.20.254
ip dhcp-server network add address=172.16.10.0/24 dns-server=8.8.8.8,1.1.1.1 gateway=172.16.10.1
ip dhcp-server network add address=172.16.20.0/24 dns-server=8.8.8.8,1.1.1.1 gateway=172.16.20.1
